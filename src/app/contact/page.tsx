    ...
    <div className="flex flex-col justify-center items-center h-screen text-center container mx-auto">
      ...
      <div className="max-w-lg p-4 mb-6">
        <p className="text-white/70">
          "I’m always excited to connect! Whether you have a question, a project
          idea, or want to say hello, I’d love to hear from you. Feel free to
          reach out anytime—I'm open to discussing job opportunities,
          collaborations, or anything tech-related. Let’s build something great
          together!"
        </p>
      </div>
